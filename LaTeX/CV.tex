  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          {Computer Graphics, Human-Computer Interaction, Algorithm Analysis and Design, Data Structure, Object-Oriented Programming (C++), Java Language and System Design, Artificial Intelligence, Pattern Recognition and Machine Learning, Computer Vision, Compiler Principle, Computer Network, Discrete Mathematics, etc}
        \resumeItem{Programming Language}
          {Objective-C (1100+ stars on GitHub, top 100 in China in this category), C\# (40k LOC), Java (20k LOC), JavaScript, Swift, Ruby}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaboration}
          {Cooperated closely with other founders for the company to grow and raise funds. Presented projects of rct studio, now a YC W19 alumnus, at the YC Demo Day (featured by TechCrunch).}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Refactoring}
          {Rewrote the code base of the smart speaker I previously worked on at RavenTech (later brought by Baidu) using Reactive Pattern (UniRx) for better readability and stability.}
...
\section{Indie Portfolio (FinGameWorks)}
  \resumeSubHeadingListStart
  	\resumeSubheadingWithTime{Node Editor Framework}{Mar. 2019 - June 2019}
	\resumeItemListStart
        \resumeItem{Research}
        ...
        \resumeItem{Application}
          {Submitted initial Objective-C based framework for the WWDC 19 Scholarship Project (\underline{\href{https://github.com/JustinFincher/WWDC19Playground}{Creative Shader Programming}}). Ported the framework to C\# for further application in a board game engine I am working on.}
      \resumeItemListEnd
      
    \resumeSubheadingWithTime{Live Wallpaper Series}{Dec. 2017 - Feb. 2019}
	\resumeItemListStart
        \resumeItem{Research}
        ...
        \resumeItem{Application}
          {\underline{\href{https://getskyline.app/}{Skyline}}, an Android live wallpaper with global 3D terrain which ranked the most paid app on Google Play (US region, Jan. 2018) and was covered by tech sites including The Verge, LifeHacker, Android Authority, and TNW. \underline{\href{https://portfolio.justzht.com/vortexlwp}{Vortex}}, a data-driven live wallpaper that visualizes weather, time, and motion.}
      \resumeItemListEnd
	...
	\resumeSubheadingWithTime{Indie Development and Open Source}{Oct. 2015 - Jan. 2019}
	\resumeItemListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Presentation}
          {Built a 3D modeling app called 'Air Ink' with Wacom SDK and ARKit, which reached the final round of Inkathon. Presented technical key points on the Wacom Connected Ink event in Japan.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Scholarship}
          {Submitted a Swift Playground called 'Golf GO', a golf game written within 1000 lines but provides millions of maps at runtime using procedural algorithms. Granted as 1/350 WWDC winner projects globally.}
      \resumeItemListEnd
