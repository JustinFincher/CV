...
\section{Indie Portfolio (FinGameWorks)}
  \resumeSubHeadingListStart
  	\resumeSubheadingWithTime{Node Editor Framework}{Mar. 2019 - Jun. 2020}
	\resumeItemListStart
        \resumeItem{Research}
...
\section{Conferences \& Services}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Apple Worldwide Developers Conference}{San Jose, U.S.}
      {Scholar as 1/350 globally}{Jun. 2018 \& Jun. 2020}
      \resumeItemListStart
...
\resumeSubHeadingListStart
  	\resumeSubheadingCompact{2nd Place for Microsoft Research Asia \& Hunan University Hackathon}{Changsha, China}
	\resumeSubheadingCompact{1st Place for IKODE IKEA Hackathon}{Shanghai, China}
	\resumeSubheadingCompact{1st Place for SegmentFault \& AngelHack Hackathon}{Shenzhen, China}
	\resumeSubheadingCompact{3rd Place for Uber API Hackathon}{Beijing, China}
	\resumeSubheadingCompact{2nd Place for China Academy of Art Hackathon}{Hangzhou, China}
	\resumeSubheadingCompact{1st Place for SegmentFault Hackathon}{Beijing, China}
\resumeSubHeadingListEnd
